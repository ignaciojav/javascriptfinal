let carta= document.getElementById("misproductosnotebook");
let stock1 = 1;
...
usuarioAObjeto != undefined ?
  ...
  const HTMLResponse = document.getElementById("misproductosnotebook");

 
function renderizarProductos (){
  
fetch(`${API_URL}/ignaciojav/notebook/productosNotebook`)
.then ((response)=>response.json())
.then((productosNotebook)=>{

    for(const producto of productosNotebook){
    ...
    productosNotebook.forEach((producto)=>{
