...
usuarioAObjeto != undefined ?
  ...
  const HTMLResponse = document.getElementById("misproductostablets");

 
function renderizarProductos (){
  
fetch(`${API_URL}/ignaciojav/tablets/productosTablets`)
.then ((response)=>response.json())
.then((productosTablets)=>{

    for(const producto of productosTablets){
    ...
    productosTablets.forEach((producto)=>{
